...
<div class="page-header">
    ...
    <h1 class="page-title">Tambah Kategori Pengaduan</h1>
</div>
...
<div style="max-width:560px;">
    <div class="card">
        ...
        <form method="POST" action="{{ route('rt.kategori.store') }}">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" id="nama_kategori" name="nama_kategori"
                    ...
                    placeholder="cth: Keamanan, Kebersihan, Infrastruktur..."
            ...
            <div class="form-group">
                ...
                <textarea id="deskripsi" name="deskripsi" class="form-control @error('deskripsi') is-invalid @enderror"
                    placeholder="Penjelasan singkat kategori ini..." rows="4">{{ old('deskripsi') }}</textarea>
            </div>
